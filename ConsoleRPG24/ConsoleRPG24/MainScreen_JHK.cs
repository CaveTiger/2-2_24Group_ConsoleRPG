    ...
    internal partial class MainScreen
    {
        ...
        public void InitItem()
        {
            ...
            itemList.Add(new Item("어느 영웅의 대서사시", "어느 영웅도 처음에는 혼자였던 시절이 있었다.",
                " 전투 진입시 적의 수가 4명일 경우 + 공격력 12% ", Rank.epic, Division.atk, 0));

            //적이 전투중 죽었을 경우 증가
            itemList.Add(new Item("전투의 흔적", "내 동료가 죽어가는 슬픔은 이루 말로 표현할 수 없다.",
                " 적이 전투중 죽었을 경우 + 공격력 8% / 전투 종료시 소멸 ", Rank.rare, Division.atk, 0));
            ...
            itemList.Add(new Item("어느 거인의 첫 발걸음", "어느 거인의 여행기가 세상을 놀라게 하였다.",
                " 전투 진입시 적의 수가 4명일 경우 + 방어력 12% ", Rank.epic, Division.def, 0));

            //적이 전투중 죽었을 경우 증가
            itemList.Add(new Item("전투의 슬픔", "전투의 부산물로는 말로 형용할 수 없는 슬픔만이 남아있다.",
                " 적이 전투중 죽었을 경우 + 방어력 8% / 전투 종료시 소멸 ", Rank.rare, Division.def, 0));
            ...
            itemList.Add(new Item("어느 여행자의 노하우", "여행을 하면서 도움이 되만한 지식들이 적혀있다.",
                "전투 진입시 적의 수가 4명일 경우 + 최대체력 6%", Rank.rare, Division.hp, 0));
            ...
            //상점 내 아이템 수량 1 감소, 대신 상점 진입시 랜덤 아이템 획득
            itemList.Add(new Item("광대의 상자", "내가 원하는 것을 얻으려면 그만한 대가도 지불해야 한다.",
                "상점 내 아이템 수량 1 감소, 대신 상점 진입시 랜덤 아이템 획득", Rank.epic, Division.shop, 0));
