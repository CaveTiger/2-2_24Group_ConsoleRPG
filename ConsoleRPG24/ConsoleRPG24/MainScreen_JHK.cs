...
namespace ConsoleRPG24
{
    ...
    internal partial class MainScreen
    {
        ...
        public void InitItem()
        {
            ...
            //용병을 팀 내에서 제외시킬 경우, 최초 1회에 한해서 배신하지 않고 떠남 (배신 시스템이 추가될 경우)
            itemlist.Add(new Item("전우의 의리", "우리들의 우정은 파티를 떠나고도 끝나지 않는다.",
                "용병을 팀 내에서 제외시킬 경우, 최초 1회에 한해서 배신하지 않고 떠남 (배신 시스템이 추가될 경우)", Rank.rare, Division.mer, 0));
